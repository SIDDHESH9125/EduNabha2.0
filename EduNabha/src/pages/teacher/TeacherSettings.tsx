			...
			<div className="w-full max-w-2xl space-y-4">
				...
				<section className="card space-y-3">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
						...
						<input className="border rounded px-3 py-2" placeholder="School" />
						<input className="border rounded px-3 py-2" placeholder="Primary subject" />
					</div>
				...
				<section className="card">
					<button className="btn" onClick={() => navigate('/login?role=teacher')}>Logout</button>
				</section>
			</div>
		</div>
	)
